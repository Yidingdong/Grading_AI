...
*Switch to terminal; _HLRS directory*
python create_answer_sheets.py

*Back to mongodb*
db.exams.countDocuments({})
db.exams.find().pretty()

db.pdf_submissions.deleteMany({})
python pdf_to_mongodb.py --pdf "Lorem_ipsum.pdf" --username "ItsYid" --course "Math 101" --student "Yiding Ma"
